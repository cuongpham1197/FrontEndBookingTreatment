...
class ProfileStaff extends Component {
    ...
    renderTimeBooking = (dataTime) => {
        ...
        if (dataTime && !_.isEmpty(dataTime)) {
            ...
            return (
                <>
                    <div>{time}-{date}</div>
                    <div><FormattedMessage id="customer.booking-modal.priceBooking" /></div>
                </>
            )
        }
        return <></>
    ...
    render() {
        ...
        let { language, isShowDescriptionStaff,
            ...
            <div className="profile-staff-container">
                ...
                {isShowPrice === true &&
                    <div className="price">
                        ...
                        {dataProfile && dataProfile.Staff_Infor && language === LANGUAGES.VI &&
                            <NumberFormat
                                className="currency"
                                value={dataProfile.Staff_Infor.priceTypeData.valueVi}
                                displayType={'text'}
                        ...
                        {dataProfile && dataProfile.Staff_Infor && language === LANGUAGES.EN &&
                            <NumberFormat
                                className="currency"
                                value={dataProfile.Staff_Infor.priceTypeData.valueEn}
                                displayType={'text'}
                                thousandSeparator={true}
                                suffix={'$'}
                            />
